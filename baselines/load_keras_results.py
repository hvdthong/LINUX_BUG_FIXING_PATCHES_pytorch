...
from keras_ultis import extract_commit, reformat_commit_code_keras, extract_commit_recent_sasha, \
    extract_commit_recent_sasha_keras, write_file, extract_commit_recent_sasha_keras_ver1
...
def get_recent_results(commits, results, variation):
    ...
    write_file(path_file='./results/recent_new_funcs_results_' + variation + '.txt', data=new_results)
