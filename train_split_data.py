...
def running_split_model(train_batches, test_batches, model, params):
...
def train_split_model(train_commits, test_commits, train_dict, params):
    ...
    if torch.cuda.is_available():
        model = model.cuda()
    running_split_model(train_batches=train_batches, test_batches=test_batches, model=model, params=params)
...
if __name__ == '__main__':
    ...
    train_split_model(train_commits=loading_variable('train'), test_commits=loading_variable('test'),
