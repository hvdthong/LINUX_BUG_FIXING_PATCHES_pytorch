...
def running_all_model_update(batches, model, params):
...
def train_all_model_update(commits, params):
    ...
    if torch.cuda.is_available():
        model = model.cuda()
    running_all_model_update(batches=batches, model=model, params=params)
...
if __name__ == '__main__':
    ...
    train_all_model_update(commits=loading_variable('train_all_recent_sasha'), params=input_option)